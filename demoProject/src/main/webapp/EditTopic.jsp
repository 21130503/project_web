...
<body>
<%
    Topic topic = request.getAttribute("topic") == null ? new Topic() :  (Topic) request.getAttribute("topic");
//    Invalidate
...
<div class="container-fluid bg-secondary mb-5">
    <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
        <h1 class="font-weight-semi-bold text-uppercase mb-3">Chỉnh sửa chủ đề</h1>
    </div>
</div>
<!-- Page Header End -->
...
<div class="container-fluid pt-5">
    <form action="./editTopic" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label for="nameTopicInput">Tên chủ đề</label>
            <input value="<%=topic.getName()%>" id="nameTopicInput" name="nameTopic" type="text" class="form-control"  aria-describedby="emailHelp" placeholder="Tên chủ đề">
            <small id="errTopic" class="form-text text-muted text-danger"><%=errNameTopic%></small>
        </div>
        <div class="form-group">
            <label for="imageInterface">Ảnh đại diện</label>
            <input type="file" accept="image/*" class="form-control" name="interfaceImage" id="imageInterface" placeholder="Ảnh đại diện">
            <img style="width: 400px;" id="showImage" class="mt-4" src="<%=topic.getImageInterface()%>" alt="ảnh đại diện">
        </div>
