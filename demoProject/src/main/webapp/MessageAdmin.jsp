        ...
        <div class="user-list">
            <div class="chat-item">
                ...
                <div class="user flex a-center ">
                    <button id="idUser" hidden value="<%=user.getId()%>"></button>
        ...
        >
            <header class="header-chat flex align-items-center justify-content-between">
                <div class="information-user-chat flex a-center">
                    <div class="avatar">
                        <img style="height: 100%;" src="./assets/images/faces/face2.jpg" alt="">
                    </div>
                    <h3>Nguoi dung hien tai</h3>
                </div>
            </header>
            <div class="chat-container">
                <div class="detail-account flex flex-column a-center">
                    ...
                    <div class="information">
                        <h3>Admin</h3>
                        <p>Chat hien tai · Quản trị viên</p>
                    </div>
                </div>
...
<script>
    ...
    socket.emit('add-user', 1) //current_id
    let newMess = null
    ...
    const btnIds = Array.from(document.querySelectorAll("#idUser"));
    const ids = btnIds.map((btn) => btn.value)
    console.log(ids)
