...
<%
    ...
    List<ReportKeys> reportKeysList = (List<ReportKeys>) session.getAttribute("reportKeysList");
...
<div class="container-fluid bg-secondary mb-5" style="margin-bottom: 1rem !important;">
    <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 45px">
        <div class="d-inline-flex" style="text-align: left">
            ...
            <p class="m-0 px-2"> / </p>
            <p class="m-0"  >REPORT KEY MANAGEMENT</p>
        </div>
    </div>
</div>
<!-- Page Header End -->
    ...
    <div class="row px-xl-5">
        ...
        <table class="table table-bordered text-center mb-0">
            ...
            <tr class="align-middle">
                <th style="width: 102px">RP Key ID</th>
                <th style="width: 123px">PublicKey ID</th>
                <th style="width: 130px">RP Date</th>
                <th style="width: 130px">RP Time</th>
                <th >Reason</th>
                <th style="width: 130px">View PubKey</th>
            </tr>
            </thead>
            <tbody class="align-middle">
            <%
                if (reportKeysList != null) {
                    for (ReportKeys rpKey : reportKeysList) {
            %>
            <tr>
                <td class="text-left"><i class="fas fa-key text-primary"></i> <%= rpKey.getId() %> </td>
                <td class="text-left"><i class="fas fa-key text-primary"></i> <%= rpKey.getPublicKeysId() %> </td>
                <td class="align-middle"><%= rpKey.getDate() %></td>
                <td class="align-middle"><%= rpKey.getTime() %></td>
                <td class="align-middle"><%= rpKey.getReason() %></td>
                <td class="align-middle">
                    <button class="btn btn-link p-0" onclick="showFullKey('<%= rpKey.getPublicKey(rpKey.getPublicKeysId()) %>')" style="color: black; padding: 5px !important; background-color: #D19C97; border-radius: 9px;">
                        View
                    </button>
                    <script>
