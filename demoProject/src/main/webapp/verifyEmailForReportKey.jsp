...
<html>
<head>
    <title>Verify Code For Report PriKey</title>
    <meta charset="UTF-8">
    <meta name="viewport"
...
<%--    <h1 class="logo">Nhóm 26</h1>--%>
    <h3 class="title">Xác thực Email là của bạn trước khi ReportKey</h3>
    <div class="code">
        <p class="code-content">
        </p>
    </div>
    <form action="./report-priKey?action=verify-email" method="post" class="form" id="form">
