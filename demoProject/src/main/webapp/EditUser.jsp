...
%>
<%
    String invalidateCode = (String) request.getAttribute("invalidateCode") == null ? "" : (String) request.getAttribute("invalidateCode");
...
<div class="inner">
    ...
    <form action="./edit-infor" method="post" class="form" id="form">
        <div class="form-group">
            <input type="number" placeholder="Mã xác thực" class="caret" name="code" >
            <span class="show-message"><%=invalidateCode%></span>
        </div>
        <div class="form-group">
            <input type="text" placeholder="Tên người dùng" class="caret" name="username" value="<%=user.getUsername()%>">
            <span class="show-message"><%=invalidateUserName%></span>
        </div>
        <div class="form-group">
            <input name="password" type="password" placeholder="Nhập mật khẩu" class="caret" value="<%=user.getPasword()%>">
            <span class="show-message"><%=invalidatePassword%></span>
        </div>
        <div class="form-group">
            <input type="password" placeholder="Nhập lại mật khẩu" class="caret"
                   name="password_confirmation" value="<%=user.getPasword()%>">
