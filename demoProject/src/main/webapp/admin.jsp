...
//    Tổng đơn hủy
    ...
    int totalCancelThisMonth = (int) request.getAttribute("totalCancelThisMonth");
//    Tổng đơn đặt hàng
            ...
            <li class="nav-item menu-items">
              ...
              <span class="menu-icon">
                <i class="mdi mdi-speedometer"></i>
                    ...
                    <span class="menu-title">Quản lí chủ đề</span>
                </a>
            </li>
            <li class="nav-item menu-items">
                ...
                <ul class="navbar-nav navbar-nav-right">
                    <li class="nav-item dropdown d-none d-lg-block">
                        <a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown"
                           data-toggle="dropdown" aria-expanded="false" href="#">+Thêm mới</a>
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                             aria-labelledby="createbuttonDropdown">
                            <h6 class="p-3 mb-0">Thêm sản phẩm mới</h6>
                            <div class="dropdown-divider"></div>
                            <a href="./topic" class="dropdown-item preview-item">
                                <div class="preview-thumbnail">
                                    <div class="preview-icon bg-dark rounded-circle">
                                ...
                                <div class="preview-item-content">
                                    <p class="preview-subject ellipsis mb-1">Thêm chủ đề</p>
                                </div>
                            </a>
                            <div class="dropdown-divider"></div>
                            <a href="./product" class="dropdown-item preview-item">
                                <div class="preview-thumbnail">
                                    <div class="preview-icon bg-dark rounded-circle">
                                ...
                                <div class="preview-item-content">
                                    <p class="preview-subject ellipsis mb-1">Thêm sản phẩm mới</p>
                                </div>
                            </a>
                            <div class="dropdown-divider"></div>
                            <div class="dropdown-divider"></div>
                    ...
                    <li class="nav-item dropdown border-left">
                        <a class="nav-link count-indicator dropdown-toggle" id="messageDropdown" href="./messageAdmin"
                           >
            ...
            <div class="content-wrapper">
                    ...
                    <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="text-muted font-weight-normal">Tổng số tài khoản đã đăng kí</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="text-muted font-weight-normal">Tổng đơn hàng đã đặt</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                    ...
                    <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="text-muted font-weight-normal">Số đơn hàng đã hủy</h6>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Thống kê mua hàng</h4>
                ...
                <div class="row ">
                    <div class="col-12 grid-margin">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Danh sách người dùng có số lượng hủy đơn cao</h4>
